...
class DialogLeading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    menuItems.add(new MenuItem(title: "Checkin / Attendance", iconLocation: 'assets/images/more_message.png', color: CustomColors.app_light_green,icon: Icon(Icons.email_rounded,color: Colors.white,),isIcon: true));
    ...
    menuItems.add(new MenuItem(title: "History View", iconLocation: 'assets/images/more_history.png', color: CustomColors.app_light_red,icon: Icon(Icons.speed),isIcon: false));
