      ...
      Container(
        ...
        child: Column(
          children: [
                  ...
                  pageBuilder: (context, anim1, anim2) {
                    return Align(
                      ...
                      child: Container(
                        height: height*30,
                        width: width*50,
                        child: SizedBox.expand(child: DialogChangePicture()),
                  ...
                  pageBuilder: (context, anim1, anim2) {
                    return Align(
                      ...
                      child: Container(
                        height: height*35,
                        width: width*50,
                        child: SizedBox.expand(child: DialogChangePassword()),
                        margin: EdgeInsets.only(bottom: 50, left: 12, right: 12),
                        decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.circular(15),
            ...
            GestureDetector(
              onTap: () {
                DialogUtils.showCustomDialog(context, title: "Confirm logout",
